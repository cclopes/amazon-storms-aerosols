...
# - Encontrando, selecionando e abrindo os arquivos
...
# display.plot_vpt('reflectivity', vmin=-30, vmax=70,
#                  time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_ge_a1_z.png', dpi=300,
#             bbox_inches='tight')
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt('mean_doppler_velocity', vmin=-10, vmax=10,
#                  cmap='pyart_BuDRd18', time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_ge_a1_v.png', dpi=300,
#             bbox_inches='tight')
...
#                  time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_ge_b1_z.png', dpi=300,
#             bbox_inches='tight')
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt('mean_doppler_velocity', vmin=-10, vmax=10,
#                  cmap='pyart_BuDRd18', time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_ge_b1_v.png', dpi=300,
#             bbox_inches='tight')
...
#                  time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_md_a1_z.png', dpi=300,
#             bbox_inches='tight')
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt('mean_doppler_velocity', vmin=-10, vmax=10,
#                  cmap='pyart_BuDRd18', time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_md_a1_v.png', dpi=300,
#             bbox_inches='tight')
...
#                  time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_md_b1_z.png', dpi=300,
#             bbox_inches='tight')
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt('mean_doppler_velocity', vmin=-10, vmax=10,
#                  cmap='pyart_BuDRd18', time_axis_flag=True)
# plt.ylim((0, 18))
# plt.savefig('radar_processing/figs/kazr_md_b1_v.png', dpi=300,
#             bbox_inches='tight')

# - Modificando unidades das variáveis do MIRA a serem plotadas
...
# Gerando eixo x para linha de Melting Layer Height
...
plt.plot(
    times, mira_melt_hei[0]["data"] / 1000, "k--", label=mira_melt_hei[0]["long_name"]
)
display.plot_grid_lines()
plt.legend(loc="upper right")
plt.ylim((0, 18))
plt.savefig("radar_processing/figs/mira_b_snrg.png", dpi=300, bbox_inches="tight")
plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "SNR",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_snr.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "Ze",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_ze.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "Zg",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_zg.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "Z",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_z.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "RR",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_rr.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "VELg",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_velg.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "VEL",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_vel.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "RHO",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_rho.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "RHOwav",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_rhowav.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "LDR",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_ldr.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "LDRg",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_ldrg.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "DPS",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_dps.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "DPSwav",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_dpswav.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "LWC",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_lwc.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "RMSg",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_rmsg.png", dpi=300, bbox_inches="tight")
# plt.close()
# fig = plt.figure(figsize=(12, 5))
# display.plot_vpt(
#     "RMS",
...
# )
# plt.ylim((0, 18))
# plt.savefig("radar_processing/figs/mira_b_rms.png", dpi=300, bbox_inches="tight")
# plt.close()
